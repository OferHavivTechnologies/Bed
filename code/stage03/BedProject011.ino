/*
 * This Project is used in project Bed ver 0.11 - stage 3 (transistors)
 * the project contains access to bed buttons using transistors S9014
...
{ 
  //init pins
  inMin = HeadUp; // Lowest output pin
  inMax = LegsDown; // Highest output pin
...
void loop() {
  ...
  /* 
   *  This Sub stops all moves by changing pinModes to LOW
   */
  void StopMovments()
  {
    for(int i=inMin; i<=inMax; i++)
  ...
  /*
   * This sub change status of certain pin with minial delay to HIGH
   */
